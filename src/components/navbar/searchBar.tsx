  ...
  return (
    <form>
      <div className="flex mt-3">
        <input className="px-2 py-2 my-2 w-[450px] appearance-none border focus:outline-none border-gray-400 focus:border-green-500 rounded-tl-lg rounded-bl-lg" />
        <button className="bg-green-500 hover:bg-green-600 text-white font-bold py-1 px-2 my-2 rounded-tr-lg rounded-br-lg">
